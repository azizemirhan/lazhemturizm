<?php
/**
 * Template Name: KVKK Aydınlatma Tasarımı
 *
 * @package nextcore
 */
...
$defaults = lazhem_kvkk_defaults();
$k = static function ( $key ) use ( $defaults ) {
	return lazhem_kvkk( $key, $defaults[ $key ] ?? '' );
};
?>

<main class="kvkk-page">
	<section class="kvkk-hero">
		<div class="kvkk-hero__inner">
			...
			<span class="eyebrow kvkk-hero__eyebrow"><?php echo esc_html( $k( 'kvkk_hero_eyebrow' ) ); ?></span>
			<h1 class="kvkk-hero__title">
				<?php echo wp_kses_post( $k( 'kvkk_hero_title' ) ); ?>
			</h1>
		</div>
        <div class="kvkk-hero__pattern"></div>
	</section>
            ...
            <aside class="kvkk-sidebar">
                <div class="kvkk-sidebar__sticky">
                    <div class="kvkk-index">
                        <span class="kvkk-index__title"><?php esc_html_e( 'Döküman İçeriği', 'nextcore' ); ?></span>
                    ...
                    <div class="kvkk-actions">
                        ...
                        <button type="button" class="kvkk-action-btn" onclick="copyToClipboard()">
                            ...
                            <span><?php esc_html_e( 'Bağlantıyı Kopyala', 'nextcore' ); ?></span>
                        </button>
                    </div>

                    <div class="kvkk-badge">
                        <div class="kvkk-badge__icon">
                            <i class="fas fa-shield-alt"></i>
                        </div>
                        <div class="kvkk-badge__text">
                            <strong><?php esc_html_e( 'Resmi Döküman', 'nextcore' ); ?></strong>
                            <span><?php esc_html_e( 'Lazhem Turizm A.Ş.', 'nextcore' ); ?></span>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <div class="kvkk-main">
                <div class="kvkk-meta">
                    <span class="kvkk-meta__updated">
                        ...
                        <?php printf( esc_html__( 'Son Güncelleme: %s', 'nextcore' ), esc_html( $k( 'kvkk_last_updated' ) ) ); ?>
                    </span>
                    <span class="kvkk-meta__id"><?php esc_html_e( 'Ref: KVKK-2024/05-LZM', 'nextcore' ); ?></span>
                </div>
                
                <div class="kvkk-text-block" id="kvkkContentBody">
                    <?php echo wp_kses_post( wpautop( $k( 'kvkk_content' ) ) ); ?>
                </div>
                ...
                <div class="kvkk-doc-footer">
                    <div class="kvkk-signature">
                        ...
                        <span class="kvkk-signature__title"><?php esc_html_e( 'Veri Sorumlusu', 'nextcore' ); ?></span>
                    </div>
                    <div class="kvkk-contact-mini">
                        <p><?php esc_html_e( 'Kişisel verilerinizle ilgili her türlü soru için:', 'nextcore' ); ?></p>
                        <a href="mailto:<?php echo esc_attr( lazhem_nc( 'footer_email', 'kvkk@lazhem.com' ) ); ?>">
                            <?php echo esc_html( lazhem_nc( 'footer_email', 'kvkk@lazhem.com' ) ); ?>
                        </a>
                    </div>
                </div>
            </div>
