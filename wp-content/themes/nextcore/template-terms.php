<?php
/**
 * Template Name: Kullanım Koşulları Tasarımı
 *
 * @package nextcore
 */
...
$defaults = lazhem_terms_defaults();
$k = static function ( $key ) use ( $defaults ) {
	return lazhem_terms( $key, $defaults[ $key ] ?? '' );
};
?>

<main class="kvkk-page terms-page">
	<section class="kvkk-hero">
		<div class="kvkk-hero__inner">
			...
			<span class="eyebrow kvkk-hero__eyebrow"><?php echo esc_html( $k( 'terms_hero_eyebrow' ) ); ?></span>
			<h1 class="kvkk-hero__title">
				<?php echo wp_kses_post( $k( 'terms_hero_title' ) ); ?>
			</h1>
		</div>
        <div class="kvkk-hero__pattern" style="background-position: left center; opacity: 0.3;"></div>
	</section>
            ...
            <aside class="kvkk-sidebar">
                <div class="kvkk-sidebar__sticky">
                    <div class="kvkk-index">
                        <span class="kvkk-index__title"><?php esc_html_e( 'Koşul Başlıkları', 'nextcore' ); ?></span>
                    ...
                    <div class="kvkk-actions">
                        ...
                        <button type="button" class="kvkk-action-btn" onclick="copyToClipboard()">
                            ...
                            <span><?php esc_html_e( 'Bağlantıyı Al', 'nextcore' ); ?></span>
                        </button>
                    </div>

                    <div class="kvkk-badge" style="background: var(--sage, #2d5a3d);">
                        <div class="kvkk-badge__icon">
                            <i class="fas fa-gavel"></i>
                        </div>
                        <div class="kvkk-badge__text">
                            <strong><?php esc_html_e( 'Yasal Koşullar', 'nextcore' ); ?></strong>
                            <span><?php esc_html_e( 'Son Güncelleme Kontrolü', 'nextcore' ); ?></span>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <div class="kvkk-main">
                <div class="kvkk-meta">
                    <span class="kvkk-meta__updated">
                        ...
                        <?php printf( esc_html__( 'Güncelleme: %s', 'nextcore' ), esc_html( $k( 'terms_last_updated' ) ) ); ?>
                    </span>
                    <span class="kvkk-meta__id"><?php esc_html_e( 'Ver: 1.0.4', 'nextcore' ); ?></span>
                </div>
                
                <div class="kvkk-text-block" id="kvkkContentBody">
                    <?php echo wp_kses_post( wpautop( $k( 'terms_content' ) ) ); ?>
                </div>
                ...
                <div class="kvkk-doc-footer">
                    <div class="kvkk-signature">
                        ...
                        <span class="kvkk-signature__title"><?php esc_html_e( 'Yönetim Kurulu', 'nextcore' ); ?></span>
                    </div>
                    <div class="kvkk-contact-mini">
                        <p><?php esc_html_e( 'Kullanım koşulları hakkında sorularınız mı var?', 'nextcore' ); ?></p>
                        <a href="mailto:<?php echo esc_attr( lazhem_nc( 'footer_email', 'info@lazhem.com' ) ); ?>">
                            <?php echo esc_html( lazhem_nc( 'footer_email', 'info@lazhem.com' ) ); ?>
                        </a>
                    </div>
                </div>
            </div>
...
/* Terms Specific Overrides */
.terms-page em {
    color: var(--gold-deep);
}

.terms-page .kvkk-action-btn:hover {
    background: var(--sage);
    border-color: var(--sage);
}

.terms-page .kvkk-index__link.is-active {
    color: var(--sage);
}
</style>
