<?php
/**
 * Template Name: Gizlilik Politikası Tasarımı
 *
 * @package nextcore
 */
...
$defaults = lazhem_privacy_defaults();
$k = static function ( $key ) use ( $defaults ) {
	return lazhem_privacy( $key, $defaults[ $key ] ?? '' );
};
?>

<main class="kvkk-page privacy-page">
	<section class="kvkk-hero">
		<div class="kvkk-hero__inner">
			...
			<span class="eyebrow kvkk-hero__eyebrow"><?php echo esc_html( $k( 'privacy_hero_eyebrow' ) ); ?></span>
			<h1 class="kvkk-hero__title">
				<?php echo wp_kses_post( $k( 'privacy_hero_title' ) ); ?>
			</h1>
		</div>
        <div class="kvkk-hero__pattern" style="background-position: right top; opacity: 0.25;"></div>
	</section>
            ...
            <aside class="kvkk-sidebar">
                <div class="kvkk-sidebar__sticky">
                    <div class="kvkk-index">
                        <span class="kvkk-index__title"><?php esc_html_e( 'Politika Başlıkları', 'nextcore' ); ?></span>
                    ...
                    <div class="kvkk-actions">
                        <button type="button" class="kvkk-action-btn" onclick="window.print()">
                            ...
                            <span><?php esc_html_e( 'Yazdır', 'nextcore' ); ?></span>
                        </button>
                        <button type="button" class="kvkk-action-btn" onclick="copyToClipboard()">
                            <i class="fas fa-copy"></i>
                            <span><?php esc_html_e( 'Kopyala', 'nextcore' ); ?></span>
                        </button>
                    </div>

                    <div class="kvkk-badge" style="background: var(--forest, #0f2a1d);">
                        <div class="kvkk-badge__icon">
                            <i class="fas fa-user-shield"></i>
                        </div>
                        <div class="kvkk-badge__text">
                            <strong><?php esc_html_e( 'Güvenli Bölge', 'nextcore' ); ?></strong>
                            <span><?php esc_html_e( 'SSL Sertifikalı Veri', 'nextcore' ); ?></span>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <div class="kvkk-main">
                <div class="kvkk-meta">
                    <span class="kvkk-meta__updated">
                        ...
                        <?php printf( esc_html__( 'Güncellenme: %s', 'nextcore' ), esc_html( $k( 'privacy_last_updated' ) ) ); ?>
                    </span>
                    <span class="kvkk-meta__id"><?php esc_html_e( 'Doc: LZM-PRIV-24', 'nextcore' ); ?></span>
                </div>
                
                <div class="kvkk-text-block" id="kvkkContentBody">
                    <?php echo wp_kses_post( wpautop( $k( 'privacy_content' ) ) ); ?>
                </div>
                ...
                <div class="kvkk-doc-footer">
                    <div class="kvkk-signature">
                        ...
                        <span class="kvkk-signature__title"><?php esc_html_e( 'Hukuk Müşavirliği', 'nextcore' ); ?></span>
                    </div>
                    <div class="kvkk-contact-mini">
                        <p><?php esc_html_e( 'Gizlilik haklarınızla ilgili detaylı bilgi:', 'nextcore' ); ?></p>
                        <a href="mailto:<?php echo esc_attr( lazhem_nc( 'footer_email', 'privacy@lazhem.com' ) ); ?>">
                            <?php echo esc_html( lazhem_nc( 'footer_email', 'privacy@lazhem.com' ) ); ?>
                        </a>
                    </div>
                </div>
            </div>
...
.privacy-page .kvkk-badge {
    background: var(--forest-deep);
}

.privacy-page .kvkk-index__link.is-active {
    color: var(--forest);
}
</style>
