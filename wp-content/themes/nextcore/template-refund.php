<?php
/**
 * Template Name: İptal & İade Tasarımı
 *
 * @package nextcore
 */
...
$defaults = lazhem_refund_defaults();
$k = static function ( $key ) use ( $defaults ) {
	return lazhem_refund( $key, $defaults[ $key ] ?? '' );
};
?>
...
<main class="kvkk-page">
	<section class="kvkk-hero">
		<div class="kvkk-hero__inner">
			...
			<span class="eyebrow kvkk-hero__eyebrow"><?php echo esc_html( $k( 'refund_hero_eyebrow' ) ); ?></span>
			<h1 class="kvkk-hero__title">
				<?php echo wp_kses_post( $k( 'refund_hero_title' ) ); ?>
			</h1>
		</div>
            ...
            <div class="kvkk-main">
                <div class="kvkk-meta">
                    <span class="kvkk-meta__updated">
                        ...
                        <?php printf( esc_html__( 'Son Güncelleme: %s', 'nextcore' ), esc_html( $k( 'refund_last_updated' ) ) ); ?>
                    </span>
                    <span class="kvkk-meta__id"><?php esc_html_e( 'Ref: LZM-REF-2024', 'nextcore' ); ?></span>
                </div>
                
                <div class="kvkk-text-block" id="kvkkContentBody">
                    <?php echo wp_kses_post( wpautop( $k( 'refund_content' ) ) ); ?>
                </div>
                ...
                <div class="kvkk-doc-footer">
                    <div class="kvkk-signature">
                        ...
                        <span class="kvkk-signature__title"><?php esc_html_e( 'Müşteri Hizmetleri', 'nextcore' ); ?></span>
                    </div>
                    <div class="kvkk-contact-mini">
                        <p><?php esc_html_e( 'İptal ve iade süreçleri için:', 'nextcore' ); ?></p>
