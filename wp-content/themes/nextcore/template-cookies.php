<?php
/**
 * Template Name: Çerez Politikası Tasarımı
 *
 * @package nextcore
 */
...
$defaults = lazhem_cookies_defaults();
$k = static function ( $key ) use ( $defaults ) {
	return lazhem_cookies( $key, $defaults[ $key ] ?? '' );
};
?>

<main class="kvkk-page cookies-page">
	<section class="kvkk-hero">
		<div class="kvkk-hero__inner">
			...
			<span class="eyebrow kvkk-hero__eyebrow"><?php echo esc_html( $k( 'cookies_hero_eyebrow' ) ); ?></span>
			<h1 class="kvkk-hero__title">
				<?php echo wp_kses_post( $k( 'cookies_hero_title' ) ); ?>
			</h1>
		</div>
        <div class="kvkk-hero__pattern" style="background-position: center top; opacity: 0.2;"></div>
	</section>
            ...
            <aside class="kvkk-sidebar">
                <div class="kvkk-sidebar__sticky">
                    <div class="kvkk-index">
                        <span class="kvkk-index__title"><?php esc_html_e( 'Çerez Rehberi', 'nextcore' ); ?></span>
                    ...
                    <div class="kvkk-actions">
                        <button type="button" class="kvkk-action-btn" onclick="window.print()">
                            ...
                            <span><?php esc_html_e( 'Belgeyi Yazdır', 'nextcore' ); ?></span>
                        </button>
                        <button type="button" class="kvkk-action-btn" onclick="copyToClipboard()">
                            <i class="fas fa-share"></i>
                            <span><?php esc_html_e( 'Paylaş', 'nextcore' ); ?></span>
                        </button>
                    </div>

                    <div class="kvkk-badge" style="background: var(--gold-deep, #9c7e3f);">
                        <div class="kvkk-badge__icon">
                            <i class="fas fa-cookie-bite"></i>
                        </div>
                        <div class="kvkk-badge__text">
                            <strong><?php esc_html_e( 'Şeffaf Veri', 'nextcore' ); ?></strong>
                            <span><?php esc_html_e( 'Çerez Bilgilendirmesi', 'nextcore' ); ?></span>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <div class="kvkk-main">
                <div class="kvkk-meta">
                    <span class="kvkk-meta__updated">
                        ...
                        <?php printf( esc_html__( 'Güncelleme: %s', 'nextcore' ), esc_html( $k( 'cookies_last_updated' ) ) ); ?>
                    </span>
                    <span class="kvkk-meta__id"><?php esc_html_e( 'Cookie-ID: LZM-CK-01', 'nextcore' ); ?></span>
                </div>
                
                <div class="kvkk-text-block" id="kvkkContentBody">
                    <?php echo wp_kses_post( wpautop( $k( 'cookies_content' ) ) ); ?>
                </div>
                ...
                <div class="kvkk-doc-footer">
                    <div class="kvkk-signature">
                        ...
                        <span class="kvkk-signature__title"><?php esc_html_e( 'Dijital Pazarlama', 'nextcore' ); ?></span>
                    </div>
                    <div class="kvkk-contact-mini">
                        <p><?php esc_html_e( 'Çerez tercihleriniz için bize ulaşın:', 'nextcore' ); ?></p>
...
/* Cookies Specific Overrides */
.cookies-page em {
    color: var(--gold-deep);
}

.cookies-page .kvkk-action-btn:hover {
    background: var(--gold-deep);
}

.cookies-page .kvkk-index__link.is-active {
    color: var(--gold-deep);
}
</style>
