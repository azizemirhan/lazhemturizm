    ...
    <div class="newsletter">
      <div class="newsletter__inner">
        <div class="newsletter__head">
          <div class="eyebrow">Yayla Mektubu</div>
          <h2>Karadeniz'den size <em>ilham veren</em> haberler</h2>
          <p>Sezonluk fırsatlar, yeni rotalar ve abonelere özel bungalov indirimleri — ayda yalnızca iki kez gelir.</p>
        </div>
        ...
        <form class="newsletter__form" onsubmit="event.preventDefault(); alert('Aboneliğiniz alındı, teşekkürler.');">
          ...
          <div class="newsletter__note">KVKK kapsamında verileriniz gizli tutulur · İstediğiniz zaman çıkabilirsiniz.
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="footer-main">
      <div class="footer-main__inner">
        ...
        <div class="footer-brand">
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo logo--image-only footer-logo-card" aria-label="Lazhem Turizm Anasayfa">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="Lazhem Turizm" class="logo__img">
          </a>
          <p>Karadeniz'in eşsiz doğal güzelliklerini, kültürel mirasını ve misafirperverliğini deneyimlemenin en zarif
            yolu. 2014'ten bu yana yaylalarda hayaller buluşturuyoruz.</p>
          <div class="signature">— Bulutların misafirperveri</div>
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="<?php echo esc_url( home_url( '/mavigol' ) ); ?>">Mavigöl & Giresun</a></li>
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="<?php echo esc_url( home_url( '/balayi' ) ); ?>">Balayı Paketleri</a></li>
            <li><a href="<?php echo esc_url( home_url( '/bungalov' ) ); ?>">Bungalov Konaklama</a></li>
            <li><a href="<?php echo esc_url( home_url( '/iletisim' ) ); ?>">İletişim</a></li>
            <li><a href="<?php echo esc_url( home_url( '/blog' ) ); ?>">Blog & Rehberler</a></li>
            <li><a href="<?php echo esc_url( home_url( '/yorumlar' ) ); ?>">Müşteri Yorumları</a></li>
          </ul>
        </div>
        ...
        <div class="footer-col footer-contact">
          ...
          <ul>
            <li>
              ...
              <span><strong>Ofis</strong>Cumhuriyet Cad. No:42<br>Ardeşen / Rize</span>
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path
              ...
              <span><strong>Telefon</strong><a href="tel:+904640000000">+90 464 000 00 00</a></span>
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <span><strong>E-posta</strong><a href="mailto:info@lazhemturizm.com">info@lazhemturizm.com</a></span>
            </li>
          </ul>
        </div>
    ...
    <div class="footer-bar">
      <div class="footer-bar__inner">
        <div class="footer-bar__copy">
          © 2026 <strong>Lazhem Turizm</strong> · TÜRSAB Belge No: A-0000 · Tüm hakları saklıdır.
        </div>
        <div class="footer-bar__legal">
          <a href="<?php echo esc_url( home_url( '/gizlilik' ) ); ?>">Gizlilik Politikası</a>
          <a href="<?php echo esc_url( home_url( '/kvkk' ) ); ?>">KVKK Aydınlatma Metni</a>
          <a href="<?php echo esc_url( home_url( '/iptal-iade' ) ); ?>">İptal & İade</a>
        </div>
  ...
  <nav class="bottom-nav" aria-label="Mobil hızlı erişim">
    <ul class="bottom-nav__list">
      ...
      <li class="bottom-nav__fab">
        <a href="https://wa.me/904640000000" aria-label="WhatsApp ile iletişim">
      ...
      <li>
        <a href="https://wa.me/904640000000?text=Merhaba%2C%20bilgi%20almak%20istiyorum." class="bottom-nav__item" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
  ...
  <aside class="mobile-panel" id="mobilePanel" aria-hidden="true">
    <div class="mobile-panel__head">
      ...
      <button class="mobile-panel__close" id="closeMobilePanel" aria-label="Kapat">
    ...
    <nav class="mobile-panel__nav">
      ...
      <div class="m-nav-item">
        <a class="m-nav-toggle" href="<?php echo esc_url( home_url( '/balayi' ) ); ?>">Balayı</a>
      </div>
      <div class="m-nav-item">
        <a class="m-nav-toggle" href="<?php echo esc_url( home_url( '/bungalov' ) ); ?>">Bungalov</a>
      </div>
      <div class="m-nav-item">
    ...
    <div class="mobile-panel__foot">
      <a href="https://wa.me/904640000000?text=Merhaba%2C%20bilgi%20almak%20istiyorum." class="btn btn--whats" target="_blank" rel="noopener noreferrer">
      ...
      <a href="tel:+904640000000" class="btn btn--ghost" style="color:var(--paper); border-color:rgba(201,169,97,0.3);">Telefonla
        Ara</a>

      <div class="mobile-panel__contact">
        <span>7/24 Destek</span>
        <a href="tel:+904640000000">+90 464 000 00 00</a>
      </div>
    </div>
  </aside>
